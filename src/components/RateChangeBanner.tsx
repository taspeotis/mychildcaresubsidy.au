...
export function RateChangeBanner() {
  ...
  return (
    <Container className="pt-6">
      <div className="relative flex items-start gap-3 rounded-2xl border border-brand-200 bg-gradient-to-br from-brand-50 to-brand-100/60 p-4 pr-11 shadow-sm sm:items-center sm:gap-4 sm:p-5 sm:pr-14">
